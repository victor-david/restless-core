...
* @property string  $fields       Additional fields specification
* @property string  $where        Where condition
* @property array   $parms        Query parms
* @property string  $orderBy      Order by specification
* @property int     $max          Max for selection, default 1
* @property string  $primaryKey   Primary key name, default: id
* @property string  $defaultId    Default id for selectById(), default: id
* @property int     $selectCount  Selection acount after a select op, before select op is -1
*/
abstract class DataTable extends DataObject
{
  ...
  */
  ...
  /**
  * Processes the pdo statement. Examines $this->max to determine
  * whether to populate instance properties directly (single select) or
  * to populate $this->data (array, multiple select) - and sets
  * $this->selectCount accordingly.
  *
