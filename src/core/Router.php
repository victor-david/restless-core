...
final class Router
{
    ...
    /**
     * Injects an object of user data. The data is available via $this->request->getUserObject()
     * during dispatch.
     *
     * @param object
     */
    ...
    /**
     * Dispatch the route, creating the controller object and running theaction method
     *
    ...
    public function dispatch($url)
    {
        ...
        $this->request->injectUserObject($this->userObj);
    ...
    //  *
    //  * The common Initialize class should be a basic class. It should not derive from CoreContoller.
    //  *
